...
const char* ssid = "Ekip";             //Add your WiFi ssid
const char* password =  "oooooooo";    //Add your WiFi password

String apiKey = "9541441";              //Add your Token number that bot has sent you on WhatsApp messenger
String phone_number = "+33778174958"; //Add your WhatsApp app registered phone number (same number that bot send you in url)
...
void setup() 
{
  ...
  message_to_whatsapp("Attention à votre plante.");  // you send your own message just change "hello from TechTOnions" to your message.
}
