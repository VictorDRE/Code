...
void readSensors() {
  ...
  // Vérification des erreurs de lecture pour DHT22
  ...
  // Lecture de la valeur du capteur de lumière
  ...
  // Lecture de la valeur du capteur d'humidité du sol
...
void printSensorData() {
  ...
  // Affichage des conditions de luminosité
  ...
  // Affichage des conditions d'humidité du sol
  ...
  // Affichage des conditions de l'air
