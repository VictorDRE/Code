...
private:
    ...
    unsigned long lastSummarySendTime = 0; // Last time summary data was sent
    unsigned long summaryUpdateInterval = 900000; // Interval between summary updates (15 minutes)
    unsigned long lastDailySummaryTime = 0;
    unsigned long dailySummaryInterval = 240000; // 1 minute in milliseconds for testing
    ...
    bool checkAndSendNotification(bool condition, const String& event, const String& sensor, const String& message);
};
